...
**Due Monday, March 27 @ midnight through Github**
...
* A description of your modeling approach (what method you are using) and model results presented in a tidy way, perhaps with a nice table of relevant coefficients and p-values, including a clear discussion of the effects of the variables included in the model;
